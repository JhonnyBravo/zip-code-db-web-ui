...
public class ZipCodeHelper {
  /**
   * 住所検索ページから送信されたリクエストパラメータを受け取り、 {@link ZipCodeForm} に変換して返す。
   *
   * @param request 住所検索ページから送信されたリクエストを受け取る。
   * @return form {@link ZipCodeForm} を返す。
   */
  ...
  /**
   * 住所検索ページから送信されたリクエストパラメータを受け取り、 {@link ZipCode} に変換して返す。
   *
   * @param request 住所検索ページから送信されたリクエストを受け取る。
   * @return zipcode {@link ZipCode} を返す。
   */
   ...
   *
   * @param recordset 変換対象とする都道府県の一覧を指定する。
   * @param prefecture セレクトボックス上で現在選択されている都道府県の名前を指定する。
