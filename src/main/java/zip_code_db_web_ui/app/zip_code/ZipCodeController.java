...
public class ZipCodeController {
   ...
   * index.html を返す。
   *
   * @param zipcode {@link ZipCode} エンティティを受取る。
   * @param mav {@link ModelAndView} を受取る。
   ...
   * 検索結果に応じてページを返す。
   *
   * @param request {@link HttpServletRequest} を受取る。
   * @param mav {@link ModelAndView} を受取る。
   * @return ModelAndView POST 送信時にパラメータが指定されていない場合は index.html へリダイレクトし、 パラメータが指定されている場合は
   *         search.html を返す。
   */
