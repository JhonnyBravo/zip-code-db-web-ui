...
public class ZipCodeServiceTest {
    ...
    @Test
    public void testFind郵便番号のみを指定した場合() {
    ...
    @Test
    public void testFind都道府県名のみを指定した場合() {
        final ZipCode zipcode = new ZipCode();
    ...
    @Test
    public void testFind市区郡名のみを指定した場合() {
        final ZipCode zipcode = new ZipCode();
        zipcode.setCity("札幌市%");
    ...
    @Test
    public void testFind町域名のみを指定した場合() {
        final ZipCode zipcode = new ZipCode();
        zipcode.setArea("大通%");
    ...
    @Test
    public void testFind都道府県名と市区郡名と町域名を指定した場合() {
        final ZipCode zipcode = new ZipCode();
        zipcode.setPrefecture("北海道");
        zipcode.setCity("札幌市%");
        zipcode.setArea("大通%");
    ...
    @Test
    public void testFind都道府県名と市区郡名を指定した場合() {
        final ZipCode zipcode = new ZipCode();
        zipcode.setPrefecture("北海道");
    ...
    @Test
    public void testFind都道府県名と町域名を指定した場合() {
        final ZipCode zipcode = new ZipCode();
        zipcode.setPrefecture("北海道");
        zipcode.setArea("大通%");
    ...
    @Test
    public void testFind市区郡名と町域名を指定した場合() {
        final ZipCode zipcode = new ZipCode();
        zipcode.setCity("札幌市%");
        zipcode.setArea("大通東");
    ...
    @Test
    public void testFind郵便番号と都道府県名を指定した場合() {
        final ZipCode zipcode = new ZipCode();
    ...
    @Test
    public void testFind郵便番号と市区郡名を指定した場合() {
        final ZipCode zipcode = new ZipCode();
        zipcode.setZipCode("0600041");
        zipcode.setCity("札幌市%");
    ...
    @Test
    public void testFind郵便番号と町域名を指定した場合() {
        final ZipCode zipcode = new ZipCode();
        zipcode.setZipCode("0600041");
        zipcode.setArea("大通%");
    ...
    @Test
    public void testFind郵便番号と都道府県名と市区郡名と町域名を指定した場合() {
        final ZipCode zipcode = new ZipCode();
        zipcode.setZipCode("0600041");
        zipcode.setPrefecture("北海道");
        zipcode.setCity("札幌市%");
